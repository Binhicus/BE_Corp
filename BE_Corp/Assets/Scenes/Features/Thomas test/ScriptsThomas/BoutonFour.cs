...
public class BoutonFour : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        ValeurFour.text=Temperature.ToString();
        ...
        if(pourAllumerFour==true&&TowerAngle<-0.1)
        {
            ...
            ValeurFour.enabled=true;
            VasyGros=true;
        }
        if(pourAllumerFour==true&&TowerAngle>-0.1)
        {
            SymboleAllumerFour.SetActive(false);
            ValeurFour.enabled=false;
            VasyGros=false;
        }
        ...
        {
            Temperature=50;
            ValeurFour.color=new Color(162,255,181,255);
        }
...
public void Rotate()
{
    ...
    Antenne.transform.rotation = Quaternion.Euler(0,0,(TowerAngle*-250));      
}
